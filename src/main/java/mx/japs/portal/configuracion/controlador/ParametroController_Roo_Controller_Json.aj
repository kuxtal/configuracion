...
privileged aspect ParametroController_Roo_Controller_Json {
    
    @RequestMapping(value = "/{id}", method = RequestMethod.GET, headers = "Accept=application/json")
    @ResponseBody
    public ResponseEntity<String> ParametroController.showJson(@PathVariable("id") Long id) {
    ...
    @ResponseBody
    public ResponseEntity<String> ParametroController.listJson() {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json; charset=utf-8");
        try {
    ...
    public ResponseEntity<String> ParametroController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<String> ParametroController.createFromJsonArray(@RequestBody String json) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
    ...
    public ResponseEntity<String> ParametroController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            Parametro parametro = Parametro.fromJsonToParametro(json);
    ...
    public ResponseEntity<String> ParametroController.deleteFromJson(@PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            Parametro parametro = parametroService.findParametro(id);
